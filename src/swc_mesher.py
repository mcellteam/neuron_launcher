...
class MakeCompleteMeshData_Operator ( bpy.types.Operator ):
	...
	bl_label = "Make Surface Mesh Union For All Segments"
...
#			index_number_layer.index_number_add_func(context)
	...
	def build_neuron_meta_from_segments ( self, context, segments, name = 'Neuron', tweak_le = True ):
		...
		if self.spherical_soma:
			if (len(segments) > 1 and segments[0][0][5] == 1 and segments[0][1][5] == 1 and segments[1][0][5] == 1 and segments[1][1][5] ==1 and segments[0][0][4] == segments[0][1][4] and segments[0][0][4] == segments[1][1][4]):
